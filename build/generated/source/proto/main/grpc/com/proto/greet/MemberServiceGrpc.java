...
public final class MemberServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.proto.greet.MemberRequest,
      com.proto.greet.MemberResponse> getGetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Get",
      requestType = com.proto.greet.MemberRequest.class,
      responseType = com.proto.greet.MemberResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.proto.greet.MemberRequest,
      com.proto.greet.MemberResponse> getGetMethod() {
    io.grpc.MethodDescriptor<com.proto.greet.MemberRequest, com.proto.greet.MemberResponse> getGetMethod;
      ...
      synchronized (MemberServiceGrpc.class) {
        if ((getGetMethod = MemberServiceGrpc.getGetMethod) == null) {
          MemberServiceGrpc.getGetMethod = getGetMethod =
              io.grpc.MethodDescriptor.<com.proto.greet.MemberRequest, com.proto.greet.MemberResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Get"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.greet.MemberRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.greet.MemberResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void get(com.proto.greet.MemberRequest request,
        io.grpc.stub.StreamObserver<com.proto.greet.MemberResponse> responseObserver) {
  ...
  public static final class MemberServiceStub
    ...
    /**
     */
    public void get(com.proto.greet.MemberRequest request,
        io.grpc.stub.StreamObserver<com.proto.greet.MemberResponse> responseObserver) {
  ...
  public static final class MemberServiceBlockingStub
    ...
    /**
     */
    public com.proto.greet.MemberResponse get(com.proto.greet.MemberRequest request) {
  ...
  public static final class MemberServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.proto.greet.MemberResponse> get(
        com.proto.greet.MemberRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET:
          serviceImpl.get((com.proto.greet.MemberRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.greet.MemberResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.proto.greet.MemberRequest,
              com.proto.greet.MemberResponse>(
  ...
  private static abstract class MemberServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.proto.greet.Member.getDescriptor();
    }
